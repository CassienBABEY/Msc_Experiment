...
expName = 'Train_pikachu'  # from the Builder filename that created this script
expInfo = {
    'participant': '0',
    'session': '001',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\cassi\\OneDrive\\Bureau\\Dossier_exp\\Expérimentation_Groupe\\Pikachu\\Train_pikachu_lastrun.py',
...
feedback_phrase_2 = visual.TextStim(win=win, name='feedback_phrase_2',
    text="L'anecdote a été sauvegardée par :",
    font='Open Sans',
    pos=(0, 0.25), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
# --- Initialize components for Routine "Amazon" ---
...
train_text.setText('')
# keep track of which components have finished
PikachuComponents = [anecdotes_1, train_text, blank, feedback_phrase, feedback_fichier_train_1]
...
# update component parameters for each repeat
# keep track of which components have finished
E_TComponents = [anecdotes_2, blank_2, feedback_phrase_2, feedback_fichier_train_2]
...
# --- Prepare to start Routine "Amazon" ---
continueRoutine = True
routineForceEnded = False
# update component parameters for each repeat
# keep track of which components have finished
AmazonComponents = [anecdotes_5, blank_5, feedback_phrase_5, feedback_fichier_train_5]
for thisComponent in AmazonComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
# update component parameters for each repeat
# keep track of which components have finished
R2D2Components = [anecdotes_6, blank_6, feedback_phrase_6, feedback_fichier_train_6]
...
reco_train = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/cassi/OneDrive/Bureau/Dossier_exp/Expérimentation_Groupe/StimTrainPerso1.xlsx'),
